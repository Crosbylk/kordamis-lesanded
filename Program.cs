...
namespace EsimeneProjekt //<-- nimeruum, sisaldab {} sulgude vahel konteinerit kus asub kogu programmi kood nime all "EsimeneProjekt"
{
	internal class Program //<-- programmi klass, mis on ka omakorda konteiner tüüp, Kus sees on kogu programmi kood 
	{
										...
										//käivituseks määratud
		{
			...
			//{
			//	Console.WriteLine("Sisesta aasta arv (1000 -2025): ");
			//	aasta = int.Parse(Console.ReadLine());
			//}
			//Console.WriteLine("Sisestatud aastaarv: " + aasta);
            ...
            */
			...
			//    }
			//}
			//string[] kingitused = { "Raamat", "Komplekt" };
			//for (int i = 0; i < kingitused.Length; i++)
			//{
			//	Console.WriteLine((i + 1) + ". " + ki[i]);
			...
			//}
			//Console.WriteLine("Koigi elementide korrutis on : " + korrutis);
